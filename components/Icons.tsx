...
export const EyeDropperIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg
        ...
        className={className}
    >
        <path d="m12.5 7.5-5 5a2.12 2.12 0 0 0 3 3l5-5a2.12 2.12 0 0 0-3-3Z" />
        <path d="M8.5 2.5 14 8" />
        <path d="M12 22v-6" />
        <path d="M9 16h6" />
    </svg>
);
...
export const EraserIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg
        ...
        className={className}
    >
        <path d="M19.4 4.6a2 2 0 0 1 2.8 2.8L13 17H8v-5l11.4-11.4z" />
        <path d="M21 21H3" />
    </svg>
);
